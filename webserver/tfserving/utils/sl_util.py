...
from tfserving.utils.ssd_utils import PriorMap

from tfserving.utils.bboxes import rot_matrix
from tfserving.utils.bboxes import polygon_to_rbox, rbox_to_polygon
from tfserving.utils.bboxes import polygon_to_rbox2, rbox2_to_polygon
from tfserving.utils.bboxes import polygon_to_rbox3, rbox3_to_polygon
...
class PriorUtil(object):
    ...
    def __init__(self, gamma=1.5):
        ...
        source_layers_names = ['conv4_3', 'fc7', 'conv6_2', 'conv7_2', 'conv8_2', 'conv9_2', 'conv10_2']
       ...
       # self.model = model
        ...
        output = [(64, 64), (32, 32), (16, 16), (8, 8), (4, 4), (2, 2), (1, 1)]
